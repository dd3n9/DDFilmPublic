...
{
    public record GetWatchingSessionMovieQueryHandler : IRequestHandler<GetWatchingSessionMovieQuery, Result<SessionMovieResponse>>
    {
        ...
        public GetWatchingSessionMovieQueryHandler(ISessionRepository sessionRepository,
        ...
        public async Task<Result<SessionMovieResponse>> Handle(GetWatchingSessionMovieQuery request, CancellationToken cancellationToken)
        {
            ...
            var watchedSessionMovies = await _sessionMovieReadService.GetWatchingMovieBySessionIdAsync(request.SessionId, cancellationToken);

            return Result.Ok(watchedSessionMovies.Adapt<SessionMovieResponse>());
        }
    }
}
