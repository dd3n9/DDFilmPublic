...
{
    public class GetWatchedSessionMoviesQueryHandler : IRequestHandler<GetWatchedSessionMoviesQuery, Result<PaginatedList<SessionMovieResponse>>>
    {
        ...
        public GetWatchedSessionMoviesQueryHandler(ISessionRepository sessionRepository,
        ...
        public async Task<Result<PaginatedList<SessionMovieResponse>>> Handle(GetWatchedSessionMoviesQuery request, CancellationToken cancellationToken)
        {
            ...
            var watchedSessionMovies = await _sessionMovieReadService.GetWatchedMoviesBySessionIdAsync(request.PaginationParams, request.SessionId, cancellationToken);
